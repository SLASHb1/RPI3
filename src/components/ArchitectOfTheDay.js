...
export default function ArchitectOfTheDay(props) {
    ...
    useEffect(() => {
        if (dbLoaded) {
            let allArchitects = dbSearchArchitect("", "");
            let randomIndex = getRandomInt(allArchitects.length);
            setArchitect(allArchitects[randomIndex]);
        }
